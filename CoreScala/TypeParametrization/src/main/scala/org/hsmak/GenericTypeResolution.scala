...
object GenericTypeResolution extends App {
  ...
  object WithTraitsAndClasses {
    ...
    /**
      ...
      * interface org.hsmak.GenericTypeResolution$WithAbstraction$Animal <--- now this is correct!
      */
  ...
  object WithSubTyping {
    ...
    /**
      * class scala.collection.immutable.$colon$colon
      * class scala.reflect.ManifestFactory$ClassTypeManifest
      * interface org.hsmak.GenericTypeResolution$WithSubTyping$FarmAnimal <-- surprisingly this returns FarmAnimal because of the subtyping
      */
    ...
    /**
      * class scala.collection.immutable.$colon$colon
      * class scala.reflect.ManifestFactory$ClassTypeManifest
      * interface org.hsmak.GenericTypeResolution$WithSubTyping$FarmAnimal <--- same as the previous one
      */
    inspectListOfT(animals)
    println
